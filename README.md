...
**Homelab architect - Self-hosted AI - Proxmox 3-node + Snapdragon X Elite ARM64**

[![Repos](https://img.shields.io/badge/public_repos-9-blue?style=flat-square)](https://github.com/gaiagent0?tab=repositories)
...
Focus: reliable infrastructure, local AI inference, privacy-first self-hosting.
...
`PowerShell` `Bash` `Python` `systemd` `MikroTik RouterOS`